...
<head>
  <meta charset="utf-8">
    ...
    <title>micted Admin - Log in </title>
...
<body class="hold-transition theme-primary bg-gradient-primary">
    ...
    <div class="container h-p100">
     ...
     <form method="POST" action="{{ route('login') }}">
       ...
       <input type="email" id="email" name="email" class="form-control pl-15 bg-white text-dark plc-white" placeholder="Username">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group mb-3">
  ...
  <input type="password" id="password" name="password" class="form-control pl-15 bg-white text-dark plc-white" placeholder="Password">
            </div>
        </div>
          <div class="row">
            <div class="col-6">
