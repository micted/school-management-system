...
class StudentRegController extends Controller
{
    public function StudentRegView(){
    	...
    	// dd($data['class_id']);
		$data['allData'] = AssignStudent::select('year_id','student_id','class_id','roll')->groupBy('year_id','student_id','class_id','roll')->get();		
    ...
    public function StudentRegEdit($student_id){
		...
		//$data['allData'] = AssignStudent::select('year_id','student_id','class_id')->groupBy('year_id','student_id','class_id')->get();	
