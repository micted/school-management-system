	...
	<nav class="navbar navbar-static-top pl-30">
		...
		<div class="navbar-custom-menu r-side">
			<ul class="nav navbar-nav">
				...
				<!-- from the database table 'users' where the id matches with authenticated user id then take the first col data -->

				<!-- this helps to display profile image on the header part -->
